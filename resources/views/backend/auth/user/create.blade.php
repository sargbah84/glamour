            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $model::TYPE_USER }}'}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="firstname" class="form-control" placeholder="{{ __('First Name') }}" value="{{ old('firstname') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="lastname" class="form-control" placeholder="{{ __('Last Name') }}" value="{{ old('lastname') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
