        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $user->type }}'}">
                    ...
                    <div class="form-group row">
                        <label for="firstname" class="col-md-2 col-form-label">@lang('First Name')</label>

                        <div class="col-md-10">
                            <input type="text" name="firstname" class="form-control" placeholder="{{ __('First Name') }}" value="{{ old('firstname') ?? $user->firstname }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->

                    <div class="form-group row">
                        <label for="lastname" class="col-md-2 col-form-label">@lang('Last Name')</label>

                        <div class="col-md-10">
                            <input type="text" name="lastname" class="form-control" placeholder="{{ __('Last Name') }}" value="{{ old('lastname') ?? $user->lastname }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    @if (!$user->isMasterAdmin())
                        ...
                        @if (!config('global.access.user.only_roles'))
