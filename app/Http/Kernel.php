...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'admin' => [
            /*
             * This is configurable, disable global.access.user.admin_requires_2fa instead of removing this
             */
            '2fa:enabled',
            'auth',
            'password.expires',
    ...
    protected $routeMiddleware = [
        ...
        'isSubscribed' => \App\Http\Middleware\CheckActiveSubscription::class,
    ];
